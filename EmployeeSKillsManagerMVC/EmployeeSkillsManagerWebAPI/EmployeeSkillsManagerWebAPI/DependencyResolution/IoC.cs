...
namespace EmployeeSkillsManagerWebAPI.DependencyResolution {
    public static class IoC {
        public static IContainer Initialize() {
            ObjectFactory.Initialize(x =>
                        ...
                        x.For<IEmployeeSkillsRepository>().Use<EmployeeSkillsRepository>();
                            ...
                            x.For<EmployeeSkillsDBContext>().Use<EmployeeSkillsDBContext>();
                        });
